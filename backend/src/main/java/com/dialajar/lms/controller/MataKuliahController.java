...
public class MataKuliahController {
    ...
    @Autowired
    private com.dialajar.lms.repository.ForumDiskusiRepository forumDiskusiRepository;

    // Mendapatkan semua mata kuliah untuk seorang user (berdasarkan ID user)
    @GetMapping("/user/{userId}")
    public ResponseEntity<?> getCoursesByUser(@PathVariable Long userId, @RequestParam String role) {
    ...
    // Mendapatkan detail materi dalam satu mata kuliah
