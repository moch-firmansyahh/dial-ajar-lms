      ...
      <Card className="p-6 md:p-8 border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              className="w-full border-2 border-slate-200 rounded-xl p-4 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all min-h-[120px] resize-none text-slate-700 font-medium" 
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">
              {submitType === 'upload' ? 'File Lampiran' : 'Tautan Video YouTube'}
            </label>
            
            {submitType === 'upload' ? (
              <div className="border-2 border-dashed border-primary/30 bg-primary/[0.02] rounded-2xl p-10 text-center hover:border-primary hover:bg-primary/[0.04] transition-all cursor-pointer group">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-slate-100 group-hover:scale-110 transition-transform">
                  <FileUp size={28} className="text-primary" />
                </div>
                <h4 className="text-[15px] font-medium text-slate-700 mb-1">Klik atau seret file ke area ini</h4>
                <p className="text-sm text-slate-500 mb-4">Format yang didukung: PDF, DOC, ZIP (maks. 25MB)</p>
                <span className="bg-primary/10 text-primary px-4 py-1.5 rounded-full text-[13px] font-medium">Pilih File</span>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input 
                    type="url" 
                    className="w-full pl-11 pr-4 py-3.5 border-2 border-slate-200 rounded-xl focus:border-red-400 focus:ring-4 focus:ring-red-500/10 outline-none transition-all font-medium text-slate-700 placeholder:text-slate-400"
